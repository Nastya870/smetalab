-- =====================================================
-- Миграция 035: Добавление реквизитов организации в tenants
-- Дата: 29.10.2025
-- Описание: Добавляем поля для реквизитов, банковских данных и должностных лиц
-- =====================================================
...
-- Комментарии к полям
COMMENT ON COLUMN tenants.company_full_name IS 'Полное наименование организации (например, ООО "Главная компания")';
...
COMMENT ON COLUMN tenants.kpp IS 'КПП организации (9 цифр, опционально)';
COMMENT ON COLUMN tenants.legal_address IS 'Юридический адрес организации';
COMMENT ON COLUMN tenants.actual_address IS 'Фактический адрес организации (опционально)';
COMMENT ON COLUMN tenants.bank_account IS 'Расчетный счет (20 цифр)';
COMMENT ON COLUMN tenants.correspondent_account IS 'Корреспондентский счет (20 цифр)';
