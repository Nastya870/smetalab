...
CREATE INDEX IF NOT EXISTS idx_works_global_only_covering
...
CREATE INDEX IF NOT EXISTS idx_works_tenant_only_covering
...
CREATE INDEX IF NOT EXISTS idx_works_code_trgm
ON works USING gin (code gin_trgm_ops);

-- 4. Index для поиска по НАЗВАНИЮ (ILIKE)  
CREATE INDEX IF NOT EXISTS idx_works_name_trgm
...
CREATE INDEX IF NOT EXISTS idx_materials_global_only_covering
...
CREATE INDEX IF NOT EXISTS idx_materials_tenant_only_covering
...
CREATE INDEX IF NOT EXISTS idx_materials_supplier_btree
ON materials (supplier)
WHERE supplier IS NOT NULL;

-- 6. Index для поиска по КАТЕГОРИИ (фильтр)
CREATE INDEX IF NOT EXISTS idx_materials_category_btree
