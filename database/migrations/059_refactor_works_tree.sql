...
DROP VIEW IF EXISTS works_with_global;
...
-- 7. Recreate works_with_global view
...
COMMENT ON VIEW works_with_global IS 'Объединённый view глобальных и тенантных работ (с поддержкой категорий)';
