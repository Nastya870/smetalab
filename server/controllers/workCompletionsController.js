 ...
 */
export const getWorkCompletions = catchAsync(async (req, res) => {
 ...
 */
export const upsertWorkCompletion = catchAsync(async (req, res) => {
  const { estimateId } = req.params;
 ...
 */
export const batchUpsertWorkCompletions = catchAsync(async (req, res) => {
  const { estimateId } = req.params;
 ...
 */
export const deleteWorkCompletion = catchAsync(async (req, res) => {
